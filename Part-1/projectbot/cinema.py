...
file_name = 'C:\\Users\\PC\\Desktop\\Python\\projectbot\\film.csv'
headers = ['film', 'category', 'age'] 


# створює файл з початковими даними
def create_posters():
    films = [
        ['Матриця', 'бойовик', 16],
        ['Друзі', 'комедія', 12],
...
updater = Updater("5693858888:AAF0-4EyoiHbcKm66SwO3XqjKaTz3_4RSog")
