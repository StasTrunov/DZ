...
def compare (update, context):
    ...
    if number_1 > number_2:
        result = '1-st number more than 2-rd'
    elif number_1 < number_2:
        result = '2-st number more than 1-rd'
    else:
        result = '2-nd number = 1-rd'
    chat = update.effective_chat
...
updater = Updater("5651601814:AAFGjtbWbKOLm0uGkjtH2lq4g4_Ke1FE4l4")
#Updater("5488677953:AAFcCr_TZkldyBeT6MVMxJO4xVdz8hhzbPM")
